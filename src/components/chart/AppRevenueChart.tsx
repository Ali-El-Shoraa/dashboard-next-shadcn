...
export default function AlternativeChart() {
  const [active, setActive] = useState<keyof typeof config>("mobile");
  ...
  return (
    <Card className="p-0">
      <CardHeader className="flex flex-col items-stretch space-y-0 p-0 sm:flex-row border-b !pb-0">
            ...
            return (
              ...
              >
                ...
                <span className="text-lg font-bold leading-none sm:text-3xl">
                  {totals[key as keyof typeof totals].toLocaleString("en-US", {
                    style: "decimal",
                  })}
                </span>
              </button>
      ...
      <CardContent className="px-6">
        <ChartContainer
          config={config}
          className="h-[186px] w-full overflow-hidden"
        >
          <BarChart
            data={data}
